...
router.register(r"doctor_monthly_stats", views.DoctorMonthlyStatisticsViewSet, basename="doctor_monthly_stats")
router.register(r"doctor_weekly_stats", views.DoctorWeeklyStatisticsViewSet, basename="doctor_weekly_stats")
router.register(r"doctor_semester_stats", views.DoctorSemesterStatisticsViewSet, basename="doctor_semester_stats")
router.register(r"doctor_yearly_stats", views.DoctorYearlyStatisticsViewSet, basename="doctor_yearly_stats")
appname = "users" 
